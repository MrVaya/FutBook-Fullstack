            ...
            <div class="card sm:my-12  w-full shadow-none">
              <div class="card-body !p-10">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-3">
                        <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="Email Address">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="flex mt-1 justify-between items-center flex-wrap">
                        <div class="form-check">
                            ...
                            <label class="form-check-label text-muted" for="terms">I agree to all the <a href="{{ route('terms.show') }}" target="_blank">Terms &amp; Condition</a></label>
                        </div>
                    </div>
